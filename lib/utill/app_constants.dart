...
class AppConstants {
  static const String appName = 'eeat';
  static const String appVersion = '10.0';
  static const AppMode appMode = AppMode.release;
  static const String baseUrl =  'https://abranfood.pt';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.portuguese, languageName: 'Portuguese', countryCode: 'PT', languageCode: 'pt'),
